...
const SectionOne = () => {
  return (
    <div className="overflow-x-hidden">
      <div className="max-w-[1112px] mx-auto my-[90px] md:my-[120px] p-5 md:p-7 ">
        ...
        <div className="flex gap-11 lg:gap-20 flex-col md:flex-row ">
          ...
          <div className="text-center md:text-left md:-order-1 md:max-w-[32rem] lg:flex-shrink-0 md:basis-[100%] max-w-[30rem] mx-auto md:mx-0">
